 ...
 "cells": [
  {
   ...
   "source": [
    ...
    "    if count == 0:\n",
    "        valid_inputs = True\n",
    "    if valid_inputs == True and sigma != 0 and T != 0: #if inputs are valid, d1 and d2 are executed\n",
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "callprice:  1.819164452867029\n",
      "putprice:  0.08983501934025431\n",
      "calldelta:  0.9772498680518208\n",
      "putdelta:  -0.02275013194817921\n",
      "gamma:  0.013497741628297016\n",
      "vega:  0.10798193302637613\n",
      "calltheta:  -0.37865249949960156\n",
      "puttheta:  0.16268863344684928\n",
      "callrho:  0.1353352832366127\n",
      "putrho:  -0.1353352832366127\n"
     ]
    }
   ],
   "source": [
    "testallfunc(2,2,2,2,1)"
   ]
  },
  {
   "cell_type": "code",
